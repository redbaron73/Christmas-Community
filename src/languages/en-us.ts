...
export const strings = {
  ...
  NAVBAR_PLEDGED_ITEMS: 'Pledged Items',
  ...
  PLEDGED_ITEMS_TITLE: 'Pledged Items',
  PLEDGED_ITEMS_HEADER: 'Your Pledged Items',
  PLEDGED_ITEMS_EMPTY: 'You haven\'t pledged for any items yet.',
  PLEDGED_ITEMS_ITEM: 'Item',
  PLEDGED_ITEMS_FOR: 'For',
  PLEDGED_ITEMS_PRICE: 'Price',
  PLEDGED_ITEMS_STATUS: 'Status',
  PLEDGED_ITEMS_ACTIONS: 'Actions',
  PLEDGED_ITEMS_PURCHASED: 'Purchased',
  PLEDGED_ITEMS_NOT_PURCHASED: 'Not Purchased',
  PLEDGED_ITEMS_MARK_PURCHASED: 'Mark as Purchased',
  PLEDGED_ITEMS_MARKED_PURCHASED: 'Item marked as purchased!',
  PLEDGED_ITEMS_NOT_PLEDGED: 'You haven\'t pledged for this item.',
  ...
  WISHLIST_PLEDGE_ANONYMOUS: 'Pledge anonymously',
  WISHLIST_PLEDGE_ANONYMOUS_BUTTON: 'Pledge anonymously',
  WISHLIST_PLEDGED_ANONYMOUS: 'Pledged anonymously',
  ADMIN_GROUPS_HEADER: 'Groups',
  ADMIN_GROUPS_SECTION_HEADER: 'Group Management',
  ADMIN_GROUPS_SECTION_DESCRIPTION: 'Manage visibility groups to control which users can see each other\'s wishlists.',
  ADMIN_GROUPS_MANAGE: 'Manage Groups',
  ADMIN_GROUPS_LIST_HEADER: 'Groups',
  ADMIN_GROUPS_NAME: 'Group Name',
  ADMIN_GROUPS_MEMBER_COUNT: 'Members',
  ADMIN_GROUPS_ACTIONS: 'Actions',
  ADMIN_GROUPS_EDIT: 'Edit',
  ADMIN_GROUPS_DELETE: 'Delete',
  ADMIN_GROUPS_NO_GROUPS: 'No groups created yet.',
  ADMIN_GROUPS_CREATE_HEADER: 'Create New Group',
  ADMIN_GROUPS_ID: 'Group ID',
  ADMIN_GROUPS_CREATE: 'Create Group',
  ADMIN_GROUPS_ADD_ERROR_NAME_EMPTY: 'Group ID cannot be empty',
  ADMIN_GROUPS_ADD_SUCCESS: 'Group created successfully',
  ADMIN_GROUPS_EDIT_HEADER: 'Edit Group: {0}',
  ADMIN_GROUPS_MEMBERS_HEADER: 'Group Members',
  ADMIN_GROUPS_MEMBER_NAME: 'Username',
  ADMIN_GROUPS_NO_MEMBERS: 'No members in this group',
  ADMIN_GROUPS_SELECT_USER: 'Select a user...',
  ADMIN_GROUPS_ADD_MEMBER: 'Add Member',
  ADMIN_GROUPS_REMOVE_MEMBER: 'Remove',
  ADMIN_GROUPS_MEMBER_ADD_SUCCESS: 'Member added successfully',
  ADMIN_GROUPS_MEMBER_REMOVE_SUCCESS: 'Member removed successfully',
  ADMIN_GROUPS_DELETE_SUCCESS: 'Group deleted successfully',
  ADMIN_COUPLES_HEADER: 'Couples',
  ADMIN_COUPLES_LIST_HEADER: 'Manage Couples',
  ADMIN_COUPLES_NAME: 'Couple Name',
  ADMIN_COUPLES_MEMBERS: 'Members',
  ADMIN_COUPLES_ACTIONS: 'Actions',
  ADMIN_COUPLES_DELETE: 'Delete',
  ADMIN_COUPLES_NO_COUPLES: 'No couples created yet.',
  ADMIN_COUPLES_CREATE_HEADER: 'Create New Couple',
  ADMIN_COUPLES_MEMBER_1: 'First Member',
  ADMIN_COUPLES_MEMBER_2: 'Second Member',
  ADMIN_COUPLES_SELECT_USER: 'Select user...',
  ADMIN_COUPLES_CREATE: 'Create Couple',
  ADMIN_COUPLES_ADD_SUCCESS: 'Couple created successfully',
  ADMIN_COUPLES_DELETE_SUCCESS: 'Couple deleted successfully',
  ADMIN_COUPLES_SECTION_HEADER: 'Couples Management',
  ADMIN_COUPLES_SECTION_DESCRIPTION: 'Manage couples and their visibility settings',
  ADMIN_COUPLES_MANAGE: 'Manage Couples',
  WISHLIST_MARKED_PURCHASED: 'Item has been marked as purchased',
  WISHLIST_COUPLE_HEADER: 'Couple Gift Options',
  WISHLIST_COUPLE_MEMBERS: 'You can mark gifts as being for both members of the couple',
  WISHLIST_FOR_COUPLE: 'This gift is for both members of the couple',
} as const
